...
1. Download: https://bit.ly/3jnffQj
2. Download: 
2. Extract the ISO from the RAR
4. Make a new folder and put the extracted ISO, the downloaded .svf file and svfx.exe in it
5. Run svfx.exe and the LTSC ISO will be created
...
List of generic keys for Windows (from https://www.thewindowsclub.com/generic-windows-10-product-keys-to-install-windows-10-enterprise):

Offical list: https://docs.microsoft.com/en-us/windows-server/get-started/kmsclientkeys

Another list: https://www.tenforums.com/tutorials/95922-generic-product-keys-install-windows-10-editions.html


Windows 10 End Users v1909, v1903, v1809 and earlier too
...
Complete list ('gvlk' keys are KMS Client keys):
